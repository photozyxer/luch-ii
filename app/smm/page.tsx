  ...
  return (
    <>
      <PageIntro
        ...
        lead="Полный контур модуля ЛУЧ-SMM на примере реального проекта — ЖК «Притяжение» (НИКС, Екатеринбург): скаут трендовых механик → генерация карусели или поста по фактам проекта → макеты в бренд-ките на реальных фото ЖК → метрики и следующая итерация. Введите свою тему — контент соберётся на лету."
      />
          ...
          <Reveal>
            <div data-reveal className="mt-20 grid gap-4 md:grid-cols-3">
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted">
                  Всё, что уходит в паблик, проходит выпускающий контроль. Модуль
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted">
                  Соберём бренд-кит, обучим модуль на ваших фактах и подключим
