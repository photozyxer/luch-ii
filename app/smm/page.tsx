...
export const metadata: Metadata = {
  title: "SMM-модуль ЛУЧ — виральные карусели в стиле ЖК | демо",
  description:
    "Живое демо SMM-агента: скаут трендовых каруселей, генерация в фирменном стиле конкретного ЖК, экспорт слайдов и контур эффективности пост → метрики → следующая итерация.",
};
  ...
  return (
    <>
      <PageIntro
        ...
        lead="Полный контур SMM-агента на примере реального проекта — ЖК «Притяжение» (НИКС, Екатеринбург): скаут трендовых механик → генерация карусели по фактам проекта → слайды в бренд-ките → метрики и следующая итерация. Введите свою тему — карусель соберётся на лету."
      />
      ...
      <section className="relative pb-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <p className="mt-10 text-xs leading-relaxed text-muted/70">
            Демо использует открытые данные prityazhenie-ekb.ru (цвета фирменного
            стиля, факты проекта; снимок 16.07.2026). Метрики скаута и контура
            эффективности — синтетические, на реальных механиках виральных
            каруселей. AI-фоны сгенерированы один раз при сборке демо.
          </p>
        </div>
      </section>
    </>
