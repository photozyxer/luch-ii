...
const features = [
  ...
  },
  {
    ...
    text: "Выявляет потребность, подбирает акцию под ситуацию клиента и считает выгоду в рублях, отрабатывает «дорого» и «подумаю», предлагает альтернативы — и закрывает на телефон и встречу.",
  },
  {
  ...
  return (
    <>
      <PageIntro
        ...
        lead="Это демо агента «Консультант ЖК» на фактуре настоящего проекта — ЖК «Притяжение» от застройщика НИКС в Екатеринбурге. Спросите про цены и акции, поторгуйтесь, скажите «дорого» — и посмотрите, как агент ведёт к сделке."
      />
          ...
          <Reveal>
            <div data-reveal>
              ...
              <p className="mt-3 text-xs leading-relaxed text-muted/70">
                Демо построено на открытых данных официального сайта
                prityazhenie-ekb.ru и публичного каталога квартир (снимок от
                16.07.2026). Цены и условия могли измениться. Оставленный в
                чате телефон попадёт в нашу демо-CRM — так мы показываем
                передачу лида.
              </p>
            </div>
          </Reveal>
