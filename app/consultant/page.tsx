  ...
  return (
    <>
      <PageIntro
        ...
        lead="Это демо модуля ЛУЧ-Консультант на фактуре настоящего проекта — ЖК «Притяжение» от застройщика НИКС в Екатеринбурге. Спросите про цены и акции, поторгуйтесь, скажите «дорого» — и посмотрите, как ИИ ведёт к сделке."
      />
