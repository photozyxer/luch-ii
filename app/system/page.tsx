...
export const metadata: Metadata = {
  ...
  description:
    "Шесть ИИ-модулей ЛУЧ по вертикалям маркетинга и продаж застройщика: звонки, аналитика, перформанс, SMM, продакшн, консультант ЖК. Один дашборд. Человек утверждает решения.",
};
  ...
  return (
    <>
      <PageIntro
        ...
        title={
          <>
            Шесть ИИ-модулей. <span className="text-spectrum">Один дашборд.</span>{" "}
