          ...
          >
            ...
            <div>
              ...
              <ul className="mt-3 list-disc space-y-1 pl-5">
                ...
                <li>
                  технические данные (IP-адрес и др.) — для защиты форм от
                  автоматических отправок и для веб-аналитики (см. раздел 8).
                </li>
              </ul>
              <p className="mt-3">
            ...
            <div>
              <h2 className="font-display text-xl font-semibold text-fg">
                8. Веб-аналитика и файлы cookie
              </h2>
              <p className="mt-3">
                Сайт использует технически необходимые файлы cookie для
                корректной работы, а также сервис веб-аналитики{" "}
                <span className="text-fg">Яндекс.Метрика</span> (включая
                Вебвизор). Метрика собирает обезличенные данные о посещении и
                поведении на сайте — технические данные (IP-адрес, тип и версия
                браузера и устройства, источник перехода, просмотренные страницы,
                действия на странице) и файлы cookie Метрики — с целью анализа
                посещаемости и улучшения сайта. Обработка этих данных
                осуществляется на стороне ООО «Яндекс» на серверах, расположенных
                на территории Российской Федерации, в соответствии с условиями
                использования сервиса. Вы можете отказаться от сбора данных,
                настроив браузер (запрет файлов cookie) или воспользовавшись
                официальными средствами отказа Яндекс.Метрики.
              </p>
            </div>
