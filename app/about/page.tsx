...
export const metadata: Metadata = {
  title: "О нас — ЛУЧ-ИИ",
  description:
    "Команда performance-маркетинга в недвижимости, которая построила собственную мультиагентную ИИ-систему. Принципы работы и для кого мы.",
};
  ...
  return (
    <>
      <PageIntro
        ...
        lead="Мы — команда performance-маркетинга, которая много лет ведёт проекты застройщиков: от квартир комфорт-класса до загородного премиума. Рутину, которая съедала часы, мы отдали собственной мультиагентной системе — и теперь предлагаем её клиентам."
      />
          ...
          <div data-reveal className="glass rounded-3xl p-7 sm:p-10">
            <div className="grid gap-8 lg:grid-cols-2">
              <p className="leading-relaxed text-muted">
                ...
                креативов — и начали строить агентов, которые делают это сами.{" "}
                <span className="text-fg">
                  Каждый агент сначала обкатывается на наших собственных
                  проектах
                </span>{" "}
